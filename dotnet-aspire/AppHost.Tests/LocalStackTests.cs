...
public sealed class LocalStackTests(AspireAppFixture fixture)
	: IClassFixture<AspireAppFixture>
{
	...
	[Fact]
	public async Task Should_RoundTripSecureString_When_AppHostStartsLocalStackWithResolvedToken()
	{
		// Arrange
